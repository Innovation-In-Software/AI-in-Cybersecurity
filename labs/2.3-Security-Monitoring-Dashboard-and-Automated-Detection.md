## Lab 2.3: Security Monitoring Dashboard and Automated Detection
...
When prompted, set a simple password you will remember (e.g., `pabcWW123`).
...
```
sudo  su - testattacker
```
Run failed sudo commands using your password:
...
The more failed sudo attempts, the better!
...
9. Log into the user you created again in part 2 and create sudo attempts to Red Team and test the alarm.
